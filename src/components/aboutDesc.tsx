export default function AboutDesc() {
  return (
    <div className="w-full md:w-3/5 px-4 flex flex-col">
      <h1 className="font-bold text-4xl font-serif my-2">Tentang Kami</h1>
      <div className="md:mr-32">
        ...
        <p>
          ...
          mimpi sederhana, kami melihat potensi besar dari setiap butir kopi
          yang dihasilkan oleh tangan-tangan petani lokal di berbagai penjuru
          Nusantara.
        </p>
      </div>
      <div className="md:mr-32">
        ...
        <p>
          ...
          kolaboratif yang mendukung kreativitas dan penghargaan atas setiap
          ide.
        </p>
      </div>
    </div>
