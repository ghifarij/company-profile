export default function TestimonialsProduct() {
  return (
        ...
        <div className="">
              ...
              <div className="box flex flex-col gap-y-4 w-full max-xl:max-w-3xl mx-auto">
                <div className="flex items-center w-full">
                  ...
                  <p className="h-2 w-full sm:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                    <span className="h-full w-[30%] rounded-[30px] bg-green-600 flex"></span>
                  </p>
                  <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                    30
                  </p>
                ...
                <div className="flex items-center w-full">
                  ...
                  <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                    <span className="h-full w-[40%] rounded-[30px] bg-green-600 flex"></span>
                  </p>
                  <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                    40
                  </p>
                ...
                <div className="flex items-center">
                  ...
                  <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                    <span className="h-full w-[20%] rounded-[30px] bg-green-600 flex"></span>
                  </p>
                  <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                    20
                  </p>
                ...
                <div className="flex items-center">
                  ...
                  <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                    <span className="h-full w-[16%] rounded-[30px] bg-green-600 flex"></span>
                  </p>
                  <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                    16
                  </p>
                ...
                <div className="flex items-center">
                  ...
                  <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                    <span className="h-full w-[8%] rounded-[30px] bg-green-600 flex"></span>
                  </p>
                  <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                    8
                  </p>
              ...
              <div className="grid grid-cols-12 h-full px-8 max-lg:py-8 rounded-3xl bg-gray-100 w-full max-xl:max-w-3xl max-xl:mx-auto">
                ...
                <div className="col-span-12 md:col-span-4 max-lg:mt-8 md:pl-8">
                  <div className="flex items-center flex-col justify-center w-full h-full ">
                    <button className="rounded-full px-6 py-4 bg-green-700 font-semibold text-lg text-white whitespace-nowrap mb-6 w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-green-800 hover:shadow-green-400">
                      Tulis Review
                    </button>
                    <button className="rounded-full px-6 py-4 bg-white font-semibold text-lg text-green-700 whitespace-nowrap w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-100 hover:shadow-indigo-200">
                      Lihat Semua
                    </button>
                  </div>
                </div>
          ...
          <div className="pb-8 border-b border-gray-200 max-xl:max-w-3xl max-xl:mx-auto">
            <h4 className="font-manrope font-semibold text-3xl leading-10 text-black mb-6">
              Review positif yang paling membantu
            </h4>
            ...
            <p className="font-normal text-lg leading-8 text-gray-500 ">
              Saya baru saja membeli kopi, mesin kopi, dan tumbler di Tanam
              Kopi, dan saya sangat puas! Kopinya berkualitas tinggi dengan rasa
              yang kaya. Mesin kopinya mudah digunakan dan menghasilkan kopi
              sempurna setiap kali. Tumblernya stylish dan menjaga suhu dengan
              baik. Pelayanan ramah dan membantu. Sangat merekomendasikan!
            </p>
          </div>
        </div>
      </div>
